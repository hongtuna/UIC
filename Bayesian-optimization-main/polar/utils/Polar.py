...
# import utils
from utils.utils import convert_array_to_signed_int, convert_to_unsigned_long
from utils.lslload import ECG_stream, ACC_stream


class polar(object):
    def __init__(self, address:str = "CE:6B:10:FE:A3:C2", ECG:bool = True, ACC:bool = True,
